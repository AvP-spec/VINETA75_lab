"""copy of connector-pyvisa.py from the original repository 
to test the connection to the Perkin Elmer DS7780 lock-in amplifier via PyVISA."""
...
if __name__ == "__main__":
    ...
    if device is not None:
        try:
            ...
            # device.read()
            device.write("REMOTE 0")  # Attempt to set the device to local mode before closing
