...
COMMENT        = "Piezo-Scan für Temperaturen 20 - 25 °C in 5 °C Schritten"
...
try:
    ...
    for i_idx, i_C in enumerate(i_list_C):
        ...
        r_man.master_diode.set_temperature(value=i_C, unit="C", silent=True)
        
        success = r_man._wait_for_temperature(laser=r_man.master_diode, target_temp=i_C, tolerance=0.05, timeout=600)
        if not success: 
    ...
    r_man.master_diode.set_temperature(
        value=16, unit="C", silent=True
    )
    r_man.laser_off()
